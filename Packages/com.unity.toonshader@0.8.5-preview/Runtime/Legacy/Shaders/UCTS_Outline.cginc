...
#include "UCTS_Input.cginc"
            ...
            VertexOutput vert (VertexInput v) {
                ...
                //end
                float Set_Outline_Width = (_Outline_Width*0.001*smoothstep( _Nearest_Distance, _Farthest_Distance, distance(objPos.rgb,_WorldSpaceCameraPos) )*_Outline_Sampler_var.rgb).r;
                //v.2.0.7.5
...
//v2.0.4
            ...
            float4 frag(VertexOutput i) : SV_Target{
                ...
                float3 Set_BaseColor = _BaseColor.rgb*_MainTex_var.rgb*i.vcolor;
