...
public class SoxAtkJiggleBoneSimple : MonoBehaviour
{
    ...
    public void JiggleBoneUpdate()
    {
        ...
        m_resultVec = (m_forceVec * m_tensionProxy * Time.fixedDeltaTime) + m_beforeInerciaVec * (Mathf.Lerp(m_inercia, 0.0f, Time.fixedDeltaTime));
        // Gravity
        m_resultVec += m_gravity * Time.fixedDeltaTime;
